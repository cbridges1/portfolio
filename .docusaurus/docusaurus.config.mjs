...
export default {
  ...
  "themeConfig": {
    ...
    "footer": {
      ...
      "links": [
        ...
        },
        {
          ...
          "items": [
            {
              "label": "Acsys",
              "to": "docs/projects/acsys"
            },
            {
              "label": "React Native AdMob",
              "to": "docs/projects/react-native-admob"
            },
            {
              "label": "Hyve",
              "to": "docs/projects/hyve"
            },
            {
              "label": "Portainer CLI",
              "to": "docs/projects/portainer-cli"
            }
          ]
        },
        {
      ...
      "copyright": "Copyright © 2026 Jalen Bridges"
    },
    "prism": {
      "theme": {
        "plain": {
